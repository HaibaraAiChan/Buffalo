...
def run(args, device, data):
	...
	for run in range(args.num_runs):
		...
		print('dataloader generation time list', data_loader_bucketing_time_list)
		print('avg dataloader generation time per epoch', np.mean(data_loader_bucketing_time_list[3:]))
